...
col_names_1<- findFreqTerms(tdm_sparse, lowfreq = 5339, highfreq = 20334)
#converting tf matrix to matrix of size 18828 x 1651
tdm_sparse<- weightTfIdf(tdm_sparse)
